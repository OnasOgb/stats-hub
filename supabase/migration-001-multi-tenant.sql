-- ============================================================
-- StatsHub — Multi-Tenant Migration
...
-- 4. Messages table (hub-scoped chat)
...
-- Increment hub stat (atomic: update member + insert log)
